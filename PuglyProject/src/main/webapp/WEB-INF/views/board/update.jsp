...
<body>
    ...
    <div class="content">
        ...
        <div class="innerOuter">
            ...
            <form id="updateForm" method="post" action="/pugly/boards/update" enctype="multipart/form-data">
                ...
                <table align="center">
                    ...
                    <tr>
                        ...
                        <td><input type="text" id="writer" class="form-control" value="${requestScope.board.nickname }" name="nickname" readonly></td>
                    </tr> 
                    <tr>
